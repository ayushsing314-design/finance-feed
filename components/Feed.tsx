...
const CATEGORIES = [
  ...
  { key: "indian-economy", label: "Indian Economy" },
  { key: "regulatory-policy", label: "Regulatory & Policy" },
  { key: "markets", label: "Indian Markets" },
  { key: "global-markets", label: "Global Markets" },
  { key: "commodities-currency", label: "Commodities & Currency" },
  { key: "company-news", label: "Company News" },
  { key: "general-finance", label: "General Finance" },
];
